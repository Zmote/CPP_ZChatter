...
globalFrame::globalFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	save_session_settings_button = new wxButton( connection_info_input, wxID_ANY, wxT("Record Settings"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	chat_text_output = new wxTextCtrl( chat_panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE );
